...
import { CHAT_SHARED_LANE, CTO_MAKE_GITHUB_PILOT_LANE } from '../config/lane-toolsets.js';
 ...
 * could not be redeemed for it. The Make pilot and shared-Chat principal are distinct restricted
 * principals, not the general CTO role.
 */
