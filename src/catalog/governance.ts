...
export const GOVERNANCE: GovRule[] = [
  ...
  { pattern: 'heygen_video_agent_session_create', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate the fixed Video Agent chat-session contract; live execution remains CTO-only and feature-gated in-handler.' },
  { pattern: 'heygen_video_agent_feedback_send', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate the fixed planning-feedback contract; live execution remains CTO-only and feature-gated in-handler.' },
  { pattern: 'heygen_video_agent_generation_approve', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate the separate generation-approval contract; live execution remains CTO-only, owner-grant gated, and dark by default.' },
  { pattern: 'heygen_video_agent_session_stop', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate the fixed stop contract; live execution remains CTO-only and locally-owned-session gated.' },
  { pattern: 'heygen_asset_upload', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate the private-Azure fixed asset contract; live upload remains CTO-only and feature-gated.' },
  { pattern: 'heygen_translation_create', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate locked-master translation; live generation remains CTO-only and owner-grant gated.' },
  { pattern: 'heygen_proofread_create', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate proofread-first localization; live creation remains CTO-only and feature-gated.' },
  { pattern: 'heygen_proofread_generate', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate final proofread generation; live generation remains CTO-only and owner-grant gated.' },
  { pattern: 'heygen_speech_preview_create', requiredRole: ['cto', 'exec', 'coo', 'cro', 'cpo', 'developer'], reason: 'Approved internal lanes may validate bounded TTS preview; live synthesis remains CTO-only and owner-grant gated.' },
