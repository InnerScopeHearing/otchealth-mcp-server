...
param(
 ...
 [Parameter(Mandatory)][ValidateSet('gpt-5.6-luna','gpt-5.6-terra')][string]$ReviewModel,
 [Parameter(Mandatory)][ValidateSet('gpt-5.6-luna','gpt-5.6-terra')][string]$ExtractorModel,
