...
async function composition(config,env,stdout){
 ...
 // Read once before any workflow is created. Downstream worker libraries require a
 // synchronous callback, while the token remains only in this process closure.
 const cfoToken=await cfoBearer();
 const bearerTokenProvider=()=>cfoToken;
